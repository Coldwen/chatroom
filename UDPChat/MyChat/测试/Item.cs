    ...
    public partial class Item : UserControl
    {
        ...
        private void Item_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (messageType == MessageType.send)
            {
                ...
                Color color = System.Drawing.Color.FromArgb(30, 110, 255);
                panel1.BackColor = color;
                Brush brushes = new SolidBrush(color);
                Point[] point = new Point[3];
                point[0] = new Point(WIDTH - 10, 10);
                point[1] = new Point(WIDTH - 20, 10);
                point[2] = new Point(WIDTH - 20, 20);
                e.Graphics.FillPolygon(brushes, point);
            }
            else if (messageType == MessageType.receive)
            {
